# Technical Standard Operating Procedure (SOP): DataDallion Framework

This document outlines the standard procedures for configuring, executing, and maintaining data pipelines using the **DataDallion Framework** from a **Technical** standpoint. It covers the core execution model, metadata schema, onboarding guide, KMS secrets configuration, orchestration details, data quality check frameworks, and operational troubleshooting.

For high-level business context, rationale, and architecture overview, please refer to the [Business Standard Operating Procedure (SOP)](file:///g:/Coding/Python/data-dallion-framework/docs/BUSINESS_SOP.md).

---

## 1. Technical Standpoint & Execution Model
...
## 2. Relational Metadata Schema (All 13 Tables)
...
## 3. Onboarding Step-by-Step SQL Guide
...
### Step 3.1: Register Bronze, Silver, and Gold Datasets (`ctlDatasetMaster`)
...
### Step 3.2: Register the Ingestion Schedule & Endpoint (`ctlDataAcquisitionDetail`)
...
### Step 3.3: Register API Credentials & Call Properties (`ctlApiConnectionsDtl` & `ctlDataAcquisitionConnectionMaster`)
...
### Step 3.4: Map Column Schemas (`CtlColumnMetadata`)
...
### Step 3.5: Configure Standardization Rules (`ctlDataStandardisationDtl`)
...
### Step 3.6: Add Data Quality Management (DQM) Validation Rules (`ctlDqmMasterDtl`)
...
### Step 3.7: Configure Gold Transformations & Joins (`ctlTransformationDependencyMaster`)
...
## 4. KMS & Secret Resolution Configuration
...
For more detail on KMS implementation details, refer to the [KMS & Secrets Guide](file:///g:/Coding/Python/data-dallion-framework/docs/KMS_DOCUMENTATION.md).
...
## 5. PySpark Core Execution Orchestration

The pipeline is triggered using a Python orchestrator file (such as `main.py`). The orchestration coordinates [PerformBronze.py](file:///g:/Coding/Python/data-dallion-framework/src/data_dallion_framework/BronzeScripts/PerformBronze.py), [SilverLayerProcess.py](file:///g:/Coding/Python/data-dallion-framework/src/data_dallion_framework/SilverScripts/SilverLayerProcess.py), and [PerformGoldLayerProcess.py](file:///g:/Coding/Python/data-dallion-framework/src/data_dallion_framework/GoldScripts/PerformGoldLayerProcess.py).
...
## 6. Data Quality Management (DQM) Validation Framework
...
## 7. Operational Troubleshooting & Logging
...
* **Recovery:**
  1. Confirm the environment configuration on the runner host matches Section 4.
